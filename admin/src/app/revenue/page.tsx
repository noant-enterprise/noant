        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2 rounded-xl border border-border bg-bg-surface p-5">
              ...
              <div className="h-[280px] animate-pulse rounded bg-bg-inset" />
            </div>
                ...
                {Array.from({ length: 3 }).map((_, i) => (
                  <div key={i} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="h-4 w-20 animate-pulse rounded bg-bg-inset" />
                      <div className="h-4 w-16 animate-pulse rounded bg-bg-inset" />
                    </div>
                    <div className="h-2 animate-pulse rounded-full bg-bg-inset" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="rounded-xl border border-border bg-bg-surface p-5">
            <h3 className="mb-4 text-sm font-medium text-text-secondary">Failed Payments</h3>
            ...
            <div className="rounded-xl border border-border bg-bg-surface p-5">
              ...
              {data.plan_breakdown.length === 0 ? (
                <EmptyState
                  icon={BarChart3}
                  title="No plan data"
                  description="Plan breakdown will appear here once subscriptions are active"
                />
              ) : (
                <div className="space-y-4">
          ...
          <div className="rounded-xl border border-border bg-bg-surface p-5">
            ...
            {data.failed_payments.length === 0 ? (
              <EmptyState
                ...
                description="All payments are processing successfully"
              />
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full">
